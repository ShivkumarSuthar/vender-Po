...
const organizationModel = express.Router(); // Change to Router() for better organization
const organizationModel = require("../../models/user/organizationModel");
const multer = require("multer");

organizationModel.use(express.json());
...
organizationModel.put("/update/:_id", upload.single("files"), async (req, res) => {
